# Generated by Django 4.2 on 2025-05-11 15:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "attendees",
                    models.ManyToManyField(
                        through="agro_linker.ThriftAttendance", to="agro_linker.user"
                    ),
                ),
                (
                    "group",
        ...
        migrations.AddField(
            ...
            name="member",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="agro_linker.user"
            ),
        ),
        migrations.CreateModel(
            name="SystemSettings",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "participants",
                    models.ManyToManyField(
                        related_name="chat_rooms", to="agro_linker.user"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name="agroanalytics",
            index=models.Index(fields=["date"], name="agro_linker_date_7b54f5_idx"),
        ),
        migrations.AddIndex(
            model_name="user",
            index=models.Index(
        ...
        migrations.AddIndex(
            model_name="thriftcontribution",
            index=models.Index(
                fields=["transaction_reference"], name="agro_linker_transac_eaadbd_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="thriftcontribution",
            index=models.Index(
                fields=["membership", "cycle"], name="agro_linker_members_b21e88_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="thriftattendance",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user", "timestamp"], name="agro_linker_user_id_e60ca0_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="systemsettings",
            index=models.Index(
                fields=["model", "object_id"], name="agro_linker_model_ec1184_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="systemsettings",
            index=models.Index(
                fields=["action", "timestamp"], name="agro_linker_action_b87cc1_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="repaymentschedule",
